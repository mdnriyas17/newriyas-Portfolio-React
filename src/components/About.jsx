...
const About = () => {
  ...
  return (
    <div id="about" className="w-full px-[8%] py-10 scroll-mt-20 overflow-hidden">
      <div data-aos="fade-up-right">
        ...
        <div className="flex w-full flex-col lg:flex-row items-center gap-10 my-20">
          <div className="relative flex justify-center lg:justify-start">
            <div data-aos="flip-left">
              <img
                src={user_image}
                alt=""
                className="w-48 sm:w-64 md:w-72 lg:w-80 rounded-3xl max-w-none"
              />
            </div>
            <div className="bg-white w-[35%] aspect-square absolute right-0 bottom-0 translate-x-1/4 translate-y-1/3 shadow-[0_4px_55px_rgba(149,0,162,0.15)] flex items-center justify-center rounded-full">
              <img
                src={circular_text}
                alt=""
          ...
          <div className="flex-1">
            <p className="mb-10 max-w-full md:max-w-2xl font-Ovo">
