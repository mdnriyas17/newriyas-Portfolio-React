...
const Header = () => {
  return (
    <div className="w-full px-[8%] text-center h-screen flex flex-col items-center justify-center gap-4 mt-8 sm:mt-4">
    ...
    <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
        ...
        <a target='_blank' href="https://drive.google.com/file/d/1I-5gJxzPbBsQkaOqbfHpbEsZ2GnTKhbQ/view?usp=drivesdk" download
