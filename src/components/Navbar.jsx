...
const Navbar = () => {
  ...
  return (
    <>
      <div
        className="box-border fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%]
    dark:hidden"
      >
      ...
      >
        <span className="w-28 cursor-pointer mx-0 mr-14 dark:hidden">
          {" "}
          MOHAMEDRIYAS{" "}
        </span>
        <span className="w-28 cursor-pointer mx-0 mr-14 hidden dark:block">
          {" "}
          MOHAMEDRIYAS{" "}
        </span>
        <ul
